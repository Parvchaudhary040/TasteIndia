...
object TasteIndiaIcons {
    ...
    val Restaurant: ImageVector by lazy {
        materialIcon("Restaurant") {
            materialPath {
                moveTo(8.1f, 13.34f); lineToRelative(2.83f, -2.83f); lineTo(3.91f, 3.5f)
                curveToRelative(-1.56f, 1.56f, -1.56f, 4.09f, 0f, 5.66f); lineToRelative(4.19f, 4.18f)
                close()
                ...
                lineTo(3.7f, 19.87f); lineToRelative(1.41f, 1.41f); lineTo(12f, 14.41f)
                lineToRelative(6.88f, 6.88f); lineToRelative(1.41f, -1.41f); lineTo(13.41f, 13f)
                close()
            }
        }
    }
